...
export function ContributingExtensions({
  ...
  return (
    ...
    >
      <h1>{pageName}</h1>
      <p>
        Thanks for considering to contribute to Awesome Arcade! Submitting an
        extension will allow others to find it, helping others in their game
        making process!
      </p>
      <p>
      ...
      <p>
        ...
        that helps you use menus in a MakeCode Arcade game, I would choose the{" "}
        {'"'}New extension{'"'} issue template:
      </p>
      <ClickableFigure
      ...
      />
      <p>And then I would fill out the template with information, like this:</p>
      <ClickableFigure
      ...
      <p>
        ...
        (obviously) but filling out the other details will help me out. Thanks!
      </p>
      ...
      <p>
        ...
        file to add an extension to the list. (Yes, it resides in an XML file.)
        Editing it will automatically fork the repository, afterwards you can
