  ...
  return (
    ...
    >
      ...
      <p>
        ...
        that helps you play MIDI music in a MakeCode Arcade game, I would choose
        the {'"'}New tool{'"'} issue template:
      </p>
      <ClickableFigure
  ...
  <toolList label="Tools">
    ...
    <!-- More tools... -->
      ...
      <p>
        ...
        the following XML to the end of the <code>{`<toolList>`}</code> element
        like so:
      </p>
